...
hide_devices() {
    ...
    f+=(
        ...
        [background_grub_jpg]=/boot/grub/themes/$(basename "${d[1]}"*)background.jpg
        [background_grub_png]=/boot/grub/themes/$(basename "${d[1]}"*)background.png
        [old_background_grub]=/boot/grub/themes/$(basename "${d[1]}"*)background_old.png
